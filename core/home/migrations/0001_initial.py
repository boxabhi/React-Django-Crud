# Generated by Django 5.0.2 on 2024-10-01 14:17
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('receipe', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='receipe_ingredents', to='home.receipe')),
            ],
        ),
    ]
